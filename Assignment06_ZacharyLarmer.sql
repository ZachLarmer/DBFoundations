...
-- 2024-11-16,ZacharyLarmer,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_ZacharyLarmer')
	 Begin 
	  Alter Database [Assignment06DB_ZacharyLarmer] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_ZacharyLarmer;
	 End
	Create Database Assignment06DB_ZacharyLarmer;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_ZacharyLarmer;
...
FROM vEmployees AS E JOIN vEmployees AS M
